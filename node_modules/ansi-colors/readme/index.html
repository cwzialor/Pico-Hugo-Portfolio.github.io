...
<main>
    <h1></h1>
    <h1 id="ansi-colors-npm-versionhttpsimgshieldsionpmvansi-colorssvgstyleflathttpswwwnpmjscompackageansi-colors-npm-monthly-downloadshttpsimgshieldsionpmdmansi-colorssvgstyleflathttpsnpmjsorgpackageansi-colors--npm-total-downloadshttpsimgshieldsionpmdtansi-colorssvgstyleflathttpsnpmjsorgpackageansi-colors-linux-build-statushttpsimgshieldsiotravisdoowbansi-colorssvgstyleflatlabeltravishttpstravis-ciorgdoowbansi-colors-windows-build-statushttpsimgshieldsioappveyorcidoowbansi-colorssvgstyleflatlabelappveyorhttpsciappveyorcomprojectdoowbansi-colors">ansi-colors <a href="https://www.npmjs.com/package/ansi-colors"><img src="https://img.shields.io/npm/v/ansi-colors.svg?style=flat" alt="NPM version"></a> <a href="https://npmjs.org/package/ansi-colors"><img src="https://img.shields.io/npm/dm/ansi-colors.svg?style=flat" alt="NPM monthly downloads"></a>  <a href="https://npmjs.org/package/ansi-colors"><img src="https://img.shields.io/npm/dt/ansi-colors.svg?style=flat" alt="NPM total downloads"></a> <a href="https://travis-ci.org/doowb/ansi-colors"><img src="https://img.shields.io/travis/doowb/ansi-colors.svg?style=flat&amp;label=Travis" alt="Linux Build Status"></a> <a href="https://ci.appveyor.com/project/doowb/ansi-colors"><img src="https://img.shields.io/appveyor/ci/doowb/ansi-colors.svg?style=flat&amp;label=AppVeyor" alt="Windows Build Status"></a></h1>
<blockquote>
<p>Collection of ansi colors and styles.</p>
</blockquote>
<h2 id="install">Install</h2>
<p>Install with <a href="https://www.npmjs.com/">npm</a>:</p>
<div class="highlight"><pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"><code class="language-sh" data-lang="sh"><span style="display:flex;"><span>$ npm install --save ansi-colors
...
<div class="highlight"><pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"><code class="language-js" data-lang="js"><span style="display:flex;"><span><span style="color:#66d9ef">var</span> <span style="color:#a6e22e">colors</span> <span style="color:#f92672">=</span> <span style="color:#a6e22e">require</span>(<span style="color:#e6db74">&#39;ansi-colors&#39;</span>);
</span></span><span style="display:flex;"><span><span style="color:#a6e22e">console</span>.<span style="color:#a6e22e">log</span>(<span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">bold</span>(<span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">cyan</span>(<span style="color:#e6db74">&#39;[info]&#39;</span>)), <span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">cyan</span>(<span style="color:#e6db74">&#39;This is some information&#39;</span>));
</span></span><span style="display:flex;"><span><span style="color:#a6e22e">console</span>.<span style="color:#a6e22e">log</span>(<span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">bold</span>(<span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">yellow</span>(<span style="color:#e6db74">&#39;[warning]&#39;</span>)), <span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">yellow</span>(<span style="color:#e6db74">&#39;This is a warning&#39;</span>));
</span></span><span style="display:flex;"><span><span style="color:#a6e22e">console</span>.<span style="color:#a6e22e">error</span>(<span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">bold</span>(<span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">red</span>(<span style="color:#e6db74">&#39;[ERROR]&#39;</span>)), <span style="color:#a6e22e">colors</span>.<span style="color:#a6e22e">red</span>(<span style="color:#e6db74">&#39;Danger! There was an error!&#39;</span>));
</span></span></code></pre></div><p><img src="https://user-images.githubusercontent.com/995160/34897845-3150daae-f7be-11e7-9706-38c42461e0ee.png" alt="image"></p>
...
<p><em>(This project&rsquo;s readme.md is generated by <a href="https://github.com/verbose/verb-generate-readme">verb</a>, please don&rsquo;t edit the readme directly. Any changes to the readme must be made in the <a href=".verb.md">.verb.md</a> readme template.)</em></p>
<p>To generate the readme, run the following command:</p>
<div class="highlight"><pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"><code class="language-sh" data-lang="sh"><span style="display:flex;"><span>$ npm install -g verbose/verb#dev verb-generate-readme <span style="color:#f92672">&amp;&amp;</span> verb
...
<div class="highlight"><pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"><code class="language-sh" data-lang="sh"><span style="display:flex;"><span>$ npm install <span style="color:#f92672">&amp;&amp;</span> npm test
</span></span></code></pre></div><h3 id="author">Author</h3>
